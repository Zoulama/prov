...
use Session;
use Event;
use LeadAssurance\Libraries\Utils;
...
class User extends Model implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract {
    ...
    {
        return $this->hasMany('LeadAssurance\Models\Invoices');
    }

    public function credit(){
         return $this->hasMany('LeadAssurance\Models\Credits');
    }

    public function achat(){
         return $this->hasMany('LeadAssurance\Models\Achats');
    }

    public function commande(){
         return $this->hasMany('LeadAssurance\Models\Commandes');
    }
    ...
    {
        return $this->hasFeature(FEATURE_MORE_INVOICE_DESIGNS) ? 11 : (Utils::isLeadAssu() ? COUNT_FREE_DESIGNS : COUNT_FREE_DESIGNS_SELF_HOST);
    }
    ...
    public static function onUpdatedUser($user)
    {
        if (!$user->getOriginal('email')
            ...
            || $user->getOriginal('email') == 'tests@test.com') {
