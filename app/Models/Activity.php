...
class Activity extends Eloquent
{
    ...
    {
        return $this->belongsTo('LeadAssurance\Models\Credit')->withTrashed();
    }
    ...
    {
        return $this->belongsTo('LeadAssurance\Models\Payment')->withTrashed();
    }

    public function task()
    {
        return $this->belongsTo('LeadAssurance\Models\Task')->withTrashed();
    }
