<?php namespace LeadAssurance\Classes\Mailers;

use LeadAssurance\Models\Invitation;
use Utils;
use Event;
use Auth;
use LeadAssurance\Services\TemplateService;
use LeadAssurance\Models\Invoice;
use LeadAssurance\Models\Payment;
use LeadAssurance\Events\InvoiceWasEmailed;
use LeadAssurance\Events\QuoteWasEmailed;
