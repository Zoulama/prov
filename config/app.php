...
return [
    ...
    */
    ...
    'providers' => [
         ...
         */
        LeadAssurance\Providers\AppServiceProvider::class,
        LeadAssurance\Providers\AuthServiceProvider::class,
        LeadAssurance\Providers\EventServiceProvider::class,
        LeadAssurance\Providers\RouteServiceProvider::class,
        LeadAssurance\Providers\ComposerServiceProvider::class,
        LeadAssurance\Providers\ConfigServiceProvider::class,
    ...
    */
    ...
    'aliases' => [
        ...
        'Utils'             => LeadAssurance\Libraries\Utils::class,
